...
import { IRPCCallContractResult, IRPCGetTransactionReceiptBase, IRPCGetTransactionResult, IRPCSendToContractResult, HtmlcoinRPC, IRPCWaitForLogsRequest, ILogEntry } from "./HtmlcoinRPC";
...
export declare class Contract {
     ...
     *      [solar](https://github.com/htmlcoin/solar). It includes the contract
     *      address, owner address, and ABI definition for methods and types.
     * @param opts - init options
     */
    constructor(rpc: HtmlcoinRPC, info: IContractInfo, opts?: IContractInitOptions);
    ...
    /**
     * Executes contract method on your own local htmlcoind node as a "simulation"

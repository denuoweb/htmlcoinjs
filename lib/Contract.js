...
const log = debug_1.default("htmlcoinjs:contract");
const { logDecoder } = require("htmlcoinjs-ethjs-abi");
...
class Contract {
    ...
    async send(method, args = [], opts = {}) {
        ...
        const sendTx = Object.assign(Object.assign({}, txinfo), { method, confirm: (n, handler) => {
    ...
    async waitLogs(req = {}) {
        ...
        const result = await this.rpc.waitforlogs(Object.assign(Object.assign({}, req), { filter }));
    ...
    onLog(fn, opts = {}) {
        ...
        const loop = async () => {
            while (true) {
                const result = await this.waitLogs(Object.assign(Object.assign({}, opts), { fromBlock: nextblock }));
    ...
    _makeSendTxReceipt(receipt) {
        ...
        return Object.assign(Object.assign({}, receiptNoLog), { logs,
            rawlogs });
    }
}

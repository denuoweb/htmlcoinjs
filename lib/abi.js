...
exports.ContractLogDecoder = exports.decodeOutputs = exports.encodeInputs = void 0;
const { decodeParams, encodeMethod, logDecoder, configure: configureABI, } = require("htmlcoinjs-ethjs-abi");
